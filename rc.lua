...
globalkeys = my_table.join(
    ...
    -- super + ... function keys
    awful.key({ modkey }, "F1", function () awful.util.spawn( "steam" ) end,
        {description = "steam", group = "function keys"}),
    awful.key({ modkey }, "F2", function () awful.util.spawn( "virtualbox" ) end,
        {description = "virtual box", group = "function keys" }),
    ...
    awful.key({ modkey }, "r", function () awful.util.spawn( mailclient ) end,
        {description = "mail client", group = "super"}),
   -- awful.key({ modkey }, "t", function () awful.util.spawn( terminal ) end,
   --     {description = "terminal", group = "super"}),
    awful.key({ modkey }, "v", function () awful.util.spawn( "opera" ) end,
        {description = "opera browser", group = "super"}),
...
clientkeys = my_table.join(
    ...
    --awful.key({ modkey,           }, "t",    awful.client.tile.toggle            ,
    --          {description = "toggle tile", group = "client"}),
    awful.key({ modkey,           }, "n",
        function (c)
